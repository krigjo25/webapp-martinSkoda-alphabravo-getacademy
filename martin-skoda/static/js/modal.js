...
const userCanSay = [
  ...
  {
    prompt:
      "Oppgradere? Jeg trodde du likte den sånn som den er, med all sin sjarm.",
    respectFactor: 0,
    isCorrect: true,
  },
  {
  ...
  {
    prompt:
      "Plagsom? Bare prøver å bringe litt liv til denne kjedelige samtalen.",
    respectFactor: 0,
    isCorrect: false,
  },
  {
  ...
  {
    prompt:
      "Racerbane? Jeg skulle ønske, men det er dessverre ikke tillatt her.",
    respectFactor: 0,
    isCorrect: false,
  },
];
